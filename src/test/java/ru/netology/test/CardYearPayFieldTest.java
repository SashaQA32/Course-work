...
public class CardYearPayFieldTest extends UiBaseTest {
    ...
    public void shouldSuccessPayIfPastYear() {
        val cardData = new Data.CardData(getApprovedCardNumber(), getValidMonth(), getPastYear(), getValidName(), getCVC());
    ...
    public void shouldSuccessPayIfLettersYear() {
        val cardData = new Data.CardData(getApprovedCardNumber(), getValidMonth(), getLettersYear(), getValidName(), getCVC());
        payPage.fillCardData(cardData);
    ...
    public void shouldSuccessPayIfYearWithOneDigit() {
        val cardData = new Data.CardData(getApprovedCardNumber(), getValidMonth(), getYearWithOneDigit(), getValidName(), getCVC());
        payPage.fillCardData(cardData);
        payPage.shouldImproperFormatNotification();
    }
    ...
    public void shouldSuccessPayIfLastYear() {
        val cardData = new Data.CardData(getApprovedCardNumber(), getValidMonth(), getLastYear(), getValidName(), getCVC());
        payPage.fillCardData(cardData);
    ...
    public void shouldSuccessPayIf23Year() {
        val cardData = new Data.CardData(getUnknownCardNumber(), getValidMonth(), get23Year(), getValidName(), getCVC());
        payPage.fillCardData(cardData);
